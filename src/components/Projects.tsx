  ...
  const projects = [
    {
      ...
      description: 'Sistema de OCR inteligente para validação de receitas médicas, utilizando Gemini AI. A solução é construída em uma arquitetura serverless segura com API Gateway e Lambdas privadas na AWS.',
